  ...
  public:
    ...
    */
    ...
    double coordToAngleRad(double coord) const {
        return mAngleRad + (coord - mRange.lower) / mRange.size() * (mRangeReversed ? -2.0 * M_PI : 2.0 * M_PI);    // mention in doc that return doesn't wrap
    }
